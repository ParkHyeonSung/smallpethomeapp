...
const styles = StyleSheet.create({
  ...
  iconButton: { width: 40, height: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  spacer: { width: 40 },
  ...
  card: { gap: 16 },
  cardDesktop: { width: '100%', maxWidth: 1400, minHeight: 820, flexDirection: 'row', gap: 0, overflow: 'hidden', borderRadius: 16, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface },
  media: { overflow: 'hidden', borderRadius: 16, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface },
  mediaDesktop: { flex: 1.45, borderWidth: 0, borderRadius: 0, backgroundColor: '#EDEEF1' },
  mediaInner: { position: 'relative', backgroundColor: '#EDEEF1' },
  imageSlide: { width: '100%' },
  image: { width: '100%', aspectRatio: 4 / 5 },
  imageCountBadge: { position: 'absolute', top: 16, right: 16, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999, backgroundColor: 'rgba(0, 0, 0, 0.6)' },
  imageCountText: { fontSize: 12, fontWeight: '600', color: '#FFFFFF' },
  carouselArrow: { position: 'absolute', top: '50%', marginTop: -20, width: 40, height: 40, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)' },
  ...
  tagCard: { position: 'absolute', left: 16, right: 16, bottom: 16, padding: 14, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.96)', gap: 6 },
  ...
  smallPillText: { fontSize: 12, fontWeight: '600', color: colors.primary },
  textCover: { minHeight: 420, padding: 24, justifyContent: 'space-between', backgroundColor: '#F2F3F6' },
  textCoverDesktop: { flex: 1, minHeight: 820, paddingHorizontal: 42, paddingVertical: 40 },
  badge: { alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999, backgroundColor: '#F5F5F7', fontSize: 11, fontWeight: '700', letterSpacing: 0.8, color: colors.textMuted },
  meta: { marginTop: 10, fontSize: 13, fontWeight: '600', color: colors.textMuted },
  textPost: { fontSize: 28, lineHeight: 38, fontWeight: '700', color: colors.primaryStrong },
  ...
  avatarFallbackText: { fontSize: 17, fontWeight: '700', color: '#FFFFFF' },
  authorMeta: { flex: 1, gap: 4 },
  author: { fontSize: 20, fontWeight: '700', color: colors.text },
  ...
  outlinePillText: { fontSize: 13, fontWeight: '600', color: colors.text },
  ...
  deletePillText: { fontSize: 13, fontWeight: '600', color: '#C24747' },
  ...
  bodyAuthor: { fontWeight: '700' },
  commentPanel: { flex: 1, minHeight: 0, gap: 14, padding: 18, borderRadius: 14, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  ...
  input: { flex: 1, minHeight: 40, borderRadius: 10, backgroundColor: colors.background, paddingHorizontal: 14, paddingVertical: 8, fontSize: 14, color: colors.text },
  submit: { alignItems: 'center', justifyContent: 'center', minWidth: 72, height: 40, paddingHorizontal: 16, borderRadius: 10, backgroundColor: colors.primary },
  submitText: { fontSize: 13, fontWeight: '600', color: '#FFFFFF' },
  overlay: { flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(0, 0, 0, 0.2)' },
  backdrop: { flex: 1 },
  sheet: { maxHeight: '82%', borderTopLeftRadius: 16, borderTopRightRadius: 16, backgroundColor: colors.surface, paddingHorizontal: 18, paddingBottom: 18 },
